/* 
 * ColoresPartidos.js
 * Definición centralizada de colores por Partido Político.
 * Extraído de la lógica hardcoded del proyecto anterior.
 */
export const COLORES_PARTIDOS = {
  "1": {
    nombre: "Alianza Creo 21 Psc 6",
    min: "#bdd7e7", // Color claro (votos bajos)
    max: "#08519c", // Color fuerte (votos altos/principal)
    principal: "#08519c"
  },
  "2": {
...
// Función auxiliar para obtener color seguro
export function getColorPartido(id) {
  return COLORES_PARTIDOS[id] || { min: "#cccccc", max: "#333333", principal: "#333333" };
}